...
$("#jdfSchem").click(function() {
  window.open("https://confluence.cip4.org/display/PUB/JDF");
});
$("#cip4").click(function() {
  window.open("https://cip4.org/");
});
$("#jdfTools").click(function() {
  window.open("https://confluence.cip4.org/display/PUB/Tools+and+Libraries");
});
...
$("#html5Logo").tooltip({
  ...
  content: "JDF-Info.com has passed the HTML5 Validation test by W3C."
});
$("#twitter").hover(
  function() {
    $(this).addClass("shadowClass");
